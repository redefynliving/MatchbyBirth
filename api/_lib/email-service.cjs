  ...
  return `
    <div style="background:#f8f4ee;padding:40px 16px;">
      <div style="max-width:600px;margin:0 auto;background:#fffdf9;border:1px solid #e8e0d6;border-radius:20px;padding:40px;">
        ...
        <p style="font-family:Georgia,serif;font-size:17px;line-height:1.75;color:#4d4653;margin:0 0 24px;">You will receive occasional Match by Birth updates when new compatibility guides, tools, or product changes go live. No account is required.</p>
        <div style="text-align:center;margin-top:32px;">
