  ...
  return (
    <main className="section-spacing bg-background min-h-screen">
      <div className="content-container max-w-2xl mx-auto text-center">
        ...
        <a href="https://checkout.stripe.com/test_payment_link_placeholder" className="inline-flex items-center justify-center px-6 py-3 bg-primary text-white rounded-xl font-semibold">Subscribe — $4.99/mo (test)</a>
      </div>
    </main>
  );
}
