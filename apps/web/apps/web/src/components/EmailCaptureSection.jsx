  ...
  return (
    <section className="mt-12 py-12 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl text-center">
      <div className="content-container max-w-2xl mx-auto">
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <input
              ...
              className="px-4 py-3 rounded-lg border border-border w-full sm:w-auto flex-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2"
            />
            <button
              type="submit"
              disabled={status === 'loading'}
              aria-busy={status === 'loading'}
              className="px-6 py-3 bg-primary text-primary-foreground rounded-lg font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2 disabled:opacity-60"
            >
        ...
        {status === 'error' && (
          <p id="email-error" role="alert" className="text-red-600 mt-3">
            {error}
          </p>
        )}
      </div>
